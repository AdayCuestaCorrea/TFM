...
\toprule
\rowcolor{naranja}
\textbf{W} & \textbf{Secuencias train} & \textbf{Épocas ejecutadas} & \textbf{Mejor época} & \textbf{MAE (val) (viajes/\allowbreak{}día)} & \textbf{RMSE (val) (viajes/\allowbreak{}día)} & \textbf{MAPE (val, \%)} & \textbf{R² (val)} \\
\midrule
