...
\toprule
\rowcolor{naranja}
\textbf{Fold} & \textbf{Épocas ejecutadas} & \textbf{Mejor época} & \textbf{Loss train (final)} & \textbf{Loss val (final)} & \textbf{MAE (viajes/\allowbreak{}día)} & \textbf{RMSE (viajes/\allowbreak{}día)} \\
\midrule
