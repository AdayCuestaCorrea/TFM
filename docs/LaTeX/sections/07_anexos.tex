...
anexo documenta la arquitectura de verificación que respalda esa afirmación: \textbf{470
...
\begin{enumerate}[nosep]
  ...
  \item \texttt{python -m pytest} — ejecuta la suite completa de 470 pruebas automatizadas (descrita
...
la suite de 470 pruebas automatizadas que verifica su comportamiento (Anexo
