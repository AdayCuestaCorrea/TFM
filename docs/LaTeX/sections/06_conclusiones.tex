...
\begin{itemize}
  ...
  \item \textbf{OE4, etapa 2 y controles.} \emph{Qué se hizo:} XGBoost sobre 552 residuos
    ...
    el híbrido queda por detrás de SARIMAX y de \texttt{xgboost\_alone} en ambas
  ...
  \item \textbf{OE5, ensamble, sensibilidad e interpretación.} \emph{Qué se hizo:} dos
    ...
    días que perseguía; el ensamble aritmético de SARIMAX y \texttt{xgboost\_alone} es el
...
No existía una regla previa para preferir \texttt{ensemble\_equal} a
\texttt{ensemble\_inverse\_mae}: ambas se calcularon en la misma ejecución y la
...
repetir la selección solo con validación sería circular, porque los pesos del inverso del
MAE proceden de esa misma partición. Aun así, la decisión de presentación se tomó a
