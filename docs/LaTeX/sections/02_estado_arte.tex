...
total (XGBoost independiente, sección \ref{sec:modelos_control}), cuyo desempeño
...
(889 a 552) se descartan por no disponer de una predicción genuinamente fuera del
pliegue de entrenamiento (OOF). Esta tercera diferencia impide, por diseño, cualquier comparación directa entre
...
ensamble ganador combina SARIMAX y XGBoost independiente, dos modelos que fallan en
...
información distinta que la hibridación secuencial no satisface plenamente.
...
XGBoost independiente (capítulo \ref{cap:resultados}), y el modelo finalmente más
