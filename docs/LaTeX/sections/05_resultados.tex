...
total superpuesta a la predicción del modelo de referencia, \texttt{ensemble\_equal}, sobre la
...
distribución de error del modelo de referencia, \texttt{ensemble\_equal}: una distribución
...
ese modelo existe en la comparación: \texttt{xgboost\_alone}, que accede a las mismas 161
...
\texttt{ensemble\_equal} es la variante con \emph{peor} MAE tanto en validación (227.588
frente a 226.418) como en test (139.725 frente a 139.681). Repetir la selección solo con
validación no la sanearía, porque escogería \texttt{ensemble\_inverse\_mae} con la misma
partición de la que proceden sus pesos, lo que es circular. El criterio que sostiene la
