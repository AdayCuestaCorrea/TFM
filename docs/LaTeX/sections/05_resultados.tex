...
reduce el error de su propia etapa 1 de 1.585.388 (fila festivo, columna LSTM
independiente de la tabla \ref{tab:desglose_dia_test}) a 666.572, una mejora del 58\,\%,
que muestra de nuevo que el mecanismo de corrección funciona como está diseñado. Aun así,
