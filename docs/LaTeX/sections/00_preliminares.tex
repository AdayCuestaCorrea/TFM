...
\begin{abstract}
  ...
  anti-fuga verificadas por una suite de 470 pruebas automatizadas. La primera
...
subject to anti-leakage guards verified by a suite of 470 automated tests. The first stage is a univariate LSTM whose training-time
